<template>
  <section class="alloy-page alloy-page--desertec">
    <div class="inner">
      <div class="alloy-featured-image">
        <img src="@/assets/images/desertec.jpg" alt="">
      </div>
      <div class="alloy-content">
        <h1>About Desert Tech</h1>
        <div class="col text">
          <h1>Nederlandse Energiemarkt Opschonen</h1>
          <p>De aarde warmt op, en dat beginnen we zo langzamerhand te merken. Het punt is echter dat de effecten 30 jaar achter lopen op de oorzaken. En sinds de jaren 80 is ons effect op het klimaat alleen maar groter geworden, kappen we meer bomen en stoten we meer CO
            <sub>2</sub> uit. Een warmer Nederland klinkt misschien leuk, maar betekent ook een stijgende zeespiegel. Sinds 1850 is die 20 cm gestegen. Eind deze eeuw is dat nog 4 keer zoveel, en we kunnen de dijken niet blijven ophogen. Daarnaast moeten we als we zo doorgaan rekening houden met een (klimaat) vluchtelingenstroom waar de huidige toestroom echt niets bij is.</p>
